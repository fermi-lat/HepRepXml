rem Setting HepRepXml v0r8p2 in %~d0%~p0
@echo off
...
%CMTROOT%\%CMTBIN%\cmt.exe setup -bat  -pack=HepRepXml -version=v0r8p2 -path="%~d0%~p0..\..\.."   -no_cleanup %1 %2 %3 %4 %5 %6 %7 %8 %9 >%cmttempfile%
